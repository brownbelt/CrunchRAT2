...
CREATE TABLE listeners (`id` INT(16) AUTO_INCREMENT, `protocol` TEXT, `external_address` TEXT, `port` TEXT, `profile` TEXT, `user_agent` TEXT, `sleep` TEXT, `download_implant_to` TEXT, `beacon_uri` TEXT, `update_uri` TEXT, `redirect_url` TEXT, PRIMARY KEY (`id`));
