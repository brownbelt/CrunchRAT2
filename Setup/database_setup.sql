...
CREATE TABLE listeners (`external_address` TEXT, `protocol` TEXT, `port` TEXT, `beacon_uri` TEXT, `update_uri` TEXT, `crt_file` TEXT, `key_file` TEXT);
CREATE TABLE tasks (`hostname` TEXT, `task_action` TEXT, `task_secondary` TEXT);
