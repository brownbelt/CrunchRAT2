...
CREATE TABLE listeners (`id` INT(16) AUTO_INCREMENT, `protocol` TEXT, `external_address` TEXT, `port` TEXT, `profile` TEXT, `user_agent` TEXT, `sleep_interval` TEXT, `beacon_uri` TEXT, `update_uri` TEXT, PRIMARY KEY (`id`));
