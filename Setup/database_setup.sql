...
CREATE TABLE listeners (`external_address` TEXT, `protocol` TEXT, `port` TEXT, `beacon_uri` TEXT, `update_uri` TEXT, `user_agent` TEXT, `executed_out_of` TEXT, `crt_file` TEXT, `key_file` TEXT);
