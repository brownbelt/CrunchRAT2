...
CREATE TABLE listeners (`id` INT(16) AUTO_INCREMENT, `protocol` TEXT, `external_address` TEXT, `port` TEXT, `profile` TEXT, `beacon_uri` TEXT, `update_uri` TEXT, `user_agent` TEXT, PRIMARY KEY (`id`));
